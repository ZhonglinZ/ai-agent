...
const generateLogoDataUrl = (name: string) => {
  ...
  const [startColor, endColor] =
    LOGO_GRADIENTS[hashString(name) % LOGO_GRADIENTS.length];
...
export const AgentBaseInfoCard: React.FC<AgentBaseInfoCardProps> = ({
  className,
}) => {
          ...
          <div className="space-y-3">
            <Form.Item
              ...
              rules={[
                ...
                {
                  pattern:
                    /^[a-zA-Z0-9\u4e00-\u9fa5][a-zA-Z0-9\u4e00-\u9fa5\s_-]*$/,
                  message:
                    "仅支持中英文、数字、空格、下划线与中划线，且需以中英文或数字开头",
                },
              ]}
