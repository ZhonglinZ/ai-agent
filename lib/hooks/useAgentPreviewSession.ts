...
export const useAgentPreviewSession = () => {
  const input = useAgentPreviewStore.use.useInput();
  const isStreaming = useAgentPreviewStore.use.useIsStreaming();
  const lastUserMessage = useAgentPreviewStore.use.useLastUserMessage();
  const lastError = useAgentPreviewStore.use.useLastError();
  const setInput = useAgentPreviewStore.use.useSetInput();
  const setStreaming = useAgentPreviewStore.use.useSetStreaming();
  const addUserMessage = useAgentPreviewStore.use.useAddUserMessage();
  const startStreaming = useAgentPreviewStore.use.useStartStreaming();
  const appendStreamContent = useAgentPreviewStore.use.useAppendStreamContent();
  const appendStreamThought = useAgentPreviewStore.use.useAppendStreamThought();
  const finishStreaming = useAgentPreviewStore.use.useFinishStreaming();
  const stopStreaming = useAgentPreviewStore.use.useStopStreaming();
  const setLastUserMessage = useAgentPreviewStore.use.useSetLastUserMessage();
  const setError = useAgentPreviewStore.use.useSetError();
  const clearError = useAgentPreviewStore.use.useClearError();
  const addDebugEvent = useAgentPreviewStore.use.useAddDebugEvent();
  const clearMessages = useAgentPreviewStore.use.useClearMessages();
