...
function mergePageLayoutConfig(
  ...
  return {
    ...
    ...(pageConfig.showSidebar !== undefined && {
      showSidebar: pageConfig.showSidebar,
    }),
    ...(pageConfig.showHeader !== undefined && {
      showHeader: pageConfig.showHeader,
    }),
    ...(pageConfig.showBreadcrumb !== undefined && {
      showBreadcrumb: pageConfig.showBreadcrumb,
    }),
    ...(pageConfig.showFooter !== undefined && {
      showFooter: pageConfig.showFooter,
    }),
    ...(pageConfig.containerClassName && {
      containerClassName: pageConfig.containerClassName,
    }),
  };
}
